...
if(window.Shopify.checkout.billing_address.country_code  == "JP" and notIncludeJa(window.Shopify.checkout.billing_address.city + window.Shopify.checkout.billing_address.address1){
